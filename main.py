...
class First(Screen):
    def __init__(self,**kwargs):
        ...
        instr = Label(text = ti)
        self.btn = Button(text ='[u]' +  'далее'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
...
class Main(Screen):
    def __init__(self,**kwargs):
        ...
        self.btn1 = Button(text ='[u]' +  'Тест Руфье'+ '[/u]', size_hint=(0.7, 0.6), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn1.on_press = self.next1
        self.btn2 = Button(text ='[u]' +  'Тренировки'+ '[/u]', size_hint=(0.7, 0.6), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn2.on_press = self.next2
        self.btn3 = Button(text ='[u]' +  'Настройки'+ '[/u]', size_hint=(0.7, 0.6), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn3.on_press = self.next3
        wimg = Image(source='main.png')
