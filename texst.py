sogl = '''ПОЛЬЗОВАТЕЛЬСКОЕ СОГЛАШЕНИЕ ДЛЯ ПРИЛОЖЕНИЯ
1. ОПРЕДЕЛЕНИЕ ПОНЯТИЙ
В тексте настоящего Соглашения нижеизложенным терминам дано следующее значение:
"Компания", "Мы", "Наш", "Нас", "Нами" или какие-либо другие схожие производные (в зависимости от контекста) означает следующее лицо: МБОУ СОШ №79 Г. ПЕНЗА, адрес местонахождения: Россия, г. Пенза, ул. Ладожская, д. 142а (включая, его филиалы и представительства как на территории Российской Федерации, так и за ее пределами, а также какие-либо другие лица, созданные в результате реорганизации Компании), которые являются владельцами Приложения или им управляют.
...
"Платформа" означает облачную платформу, на которой Компания разместила Приложение для его последующего скачивания Пользователем. Настоящее Приложение доступно для скачивания из Google Play.
...
(5) в случае проблем со здоровьем Пользователь должен проконсультироваться со специалистом, прежде чем начать пользоваться приложением.
...
отправить письмо по следующему адресу:kirden06122007@gmail.com
...
11.3. Ответственность за жизнь и здоровье пользователя несёт сам пользователь.
