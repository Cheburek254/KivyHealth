...
class train_main(Screen):
    def __init__(self,**kwargs):
        ...
        self.btn1 = Button(text ='[u]' +  'Уровень 1'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn1.on_press = self.next1

        self.btn2 = Button(text ='[u]' +  'Уровень 2'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn2.on_press = self.next2

        self.btn3 = Button(text ='[u]' +  'Уровень 3'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        ...
        right = BoxLayout(orientation = 'vertical', padding = 8, spacing = 8)
        hor = BoxLayout()
        hor.add_widget(lbl1)
...
class tr_test(Screen):
    def __init__(self,**kwargs):
        ...
        self.btn1 = Button(text ='[u]' +  'Завершить'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn1.on_press = self.back
        self.btn2 = Button(text ='[u]' +  'Запустить таймер/далее'+ '[/u]', size_hint=(0.3, 0.2), pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
...
class tr_l1_1(Screen):
    def __init__(self,**kwargs):
        ...
        self.btn = Button(text ='[u]' + 'Далее'+ '[/u]', pos_hint = {'center_x': 0.5},background_color = btn_color, markup=True)
        self.btn.on_press = self.next
        
        self.btn1 = Button(text ='[u]' +  'Завершить'+ '[/u]', pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn1.on_press = self.back
        hor = BoxLayout(size_hint=(0.8,None))
...
class tr_l1_5(Screen):
    def __init__(self,**kwargs):
        ...
        self.btn1 = Button(text ='[u]' +  'Запустить таймер'+ '[/u]', pos_hint = {'center_x': 0.5}, background_color = btn_color, markup=True)
        self.btn1.on_press = self.back
